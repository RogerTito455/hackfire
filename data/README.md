...
| `routes_cache.json` | Every demo route planned at the scenario time, written by `pnpm data:routes`. Coordinates, directions and geometry only | Yes. Covers the sample registry and the 10-resident one (30 routes); the rescue routes' text names the resident's address |
