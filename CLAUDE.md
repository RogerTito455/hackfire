...
backend/app/spread.py      Predicted spread cone; zones.py places at risk; evacuation.py routes
...
pnpm data:zones      # download places at risk from OpenStreetMap into data/
```
